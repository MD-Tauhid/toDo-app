...
const AddTaskModal = ({ children = null, modalTitle = '', setShowModal }) => {
    return (
        <div onBlur={()=>setShowModal(false)} className="flex justify-center items-center overflow-x-hidden overflow-y-auto fixed inset-0 z-50 outline-none border-none focus:outline-none bg-black/40 backdrop-blur-sm">
